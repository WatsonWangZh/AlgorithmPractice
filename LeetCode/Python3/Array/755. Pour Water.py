...
# if it moves in that direction. Also, "level" means the height of the terrain plus any water in that column.
...
# Output: [2,3,3,4]
# Explanation:
# The last droplet settles at index 1, since moving further left
