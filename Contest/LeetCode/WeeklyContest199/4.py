...
# identical characters (repeated 2 or more times) with the concatenation of 
...
# the length of the compressed string to 5, for instance delete 2 'a' 
# then we will have s = "abcccd" which compressed is abc3d. 
