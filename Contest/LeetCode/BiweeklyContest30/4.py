...
# If Alice starts removing 4 stones, 
# Bob will remove 1 stone then Alice should remove only 1 stone 
# and finally Bob removes the last one (7 -> 3 -> 2 -> 1 -> 0). 
# If Alice starts removing 1 stone, Bob will remove 4 stones 
# then Alice only can remove 1 stone and finally Bob removes the last one (7 -> 6 -> 2 -> 1 -> 0).
