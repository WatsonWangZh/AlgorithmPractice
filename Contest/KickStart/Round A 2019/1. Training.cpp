// Problem
// As the football coach at your local school, you have been tasked with picking a team of exactly P students 
// to represent your school. There are N students for you to pick from. 
// The i-th student has a skill rating Si, which is a positive integer indicating how skilled they are.
// You have decided that a team is fair if it has exactly P students on it and they all have the same skill rating. 
// That way, everyone plays as a team. Initially, it might not be possible to pick a fair team, 
...
// where x is the test case number (starting from 1) and y is the minimum number of hours of coaching needed, 
...
// In Sample Case #1, you can spend a total of 6 hours training the first student and 8 hours training the second one. 
...
// In Sample Case #2, you can already pick a fair team (the first and second student) 
// without having to do any coaching, so the answer is 0.

// In Sample Case #3, P = N, so every student will be on your team. 
// You have to spend 6 hours training the third student, so that they have a skill of 7, like everyone else. 
